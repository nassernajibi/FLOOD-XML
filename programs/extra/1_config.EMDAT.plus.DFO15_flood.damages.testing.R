...
sum(!is.na(emdat_vars$Total.Damages..Adjusted...000.US..))/sum(is.na(emdat_vars$Total.Damages..Adjusted...000.US..))*100
# 48.99722%
...
# gdp
# iso
dat_full = data.frame(damage = 1000*emdat_vars$Total.Damages..Adjusted...000.US.., # in USD (raw data comes in 1000 USD)
